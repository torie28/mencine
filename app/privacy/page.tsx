      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-lg max-w-none space-y-6 text-gray-700">
          <section>
            ...
            <p>
              Mencine Co. Ltd ("we," "us," or "our") operates this website. This
          ...
          <section>
            ...
            <p>Mencine Co. Ltd uses the collected data for various purposes:</p>
            <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>
                ...
                visitors use our website so we can improve our services.
              </li>
              <li>
                <strong>Marketing Cookies:</strong> These track your activity on
                our website and other websites to help advertisers deliver more
                relevant advertising.
              </li>
              <li>
                <strong>Functional Cookies:</strong> These remember your
                preferences to provide you with enhanced, more personalized
                features.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              You can typically find these settings in your browser's "Options"
              or "Preferences" menu. Popular browsers include instructions for
              managing cookies at the following links:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>Google Chrome</li>
          ...
          <section>
            ...
            <p>
              ...
              deletion of your personal data. You also have the right to data
              portability and to object to processing of your personal data. To
          ...
          <section>
            ...
            <p>
              ...
              collected through our service. We have no control over and assume
